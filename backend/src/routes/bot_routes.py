...
# Bot Chat Endpoint
# =========================================================
# Handles user chat messages and interacts with:
# 1. Zep memory for storing conversation history.
# 2. OpenAI GPT model for generating responses.
# 3. Calendar event functions (add, update, delete, get).
# =========================================================
...
def bot_chat():
    ...
    try:
        ...
        events = get_events_function(current_user_id, start_date_str, end_date_str)[:20]
    except Exception as e:
    ...
    if message.function_call:
        ...
        if function_name == "update_event" and "data" not in args:
            args["data"] = {}
